...
var TransactionService = /** @class */ (function () {
    ...
    TransactionService.prototype.saveTransaction = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var mapper, test, transaction, template;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mapper = new mapper_1.TransactionMapper(data.application).build();
                        test = mapper.map(data);
                        console.log(test);
                        return [4 /*yield*/, new schema_1.TransactionModel(test).save()];
                    case 1:
                        transaction = _a.sent();
                        template = this.buildTemplateToTelegram(transaction);
