...
var service_1 = __importDefault(require("../../domain/company/service"));
var CompanyController = /** @class */ (function () {
    ...
    CompanyController.prototype.index = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var name, id, fiscalNumber, corporativeName, data, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        name = req.query.name;
                        id = req.query.id;
                        fiscalNumber = req.query.fiscalNumber;
                        corporativeName = req.query.corporativeName;
                        return [4 /*yield*/, service_1.default.index(id, name, fiscalNumber, corporativeName)];
                    case 1:
                        data = _a.sent();
                        res.status(200).json(data);
                        return [3 /*break*/, 3];
    ...
    CompanyController.prototype.indexAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
