...
var service_1 = __importDefault(require("../../domain/user/service"));
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, body, data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userId = req.userId, body = req.body;
                        return [4 /*yield*/, service_1.default.update(userId, body)];
                    case 1:
                        data = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.userId;
                        return [4 /*yield*/, service_1.default.index(id)];
                    case 1:
                        data = _a.sent();
                        res.status(200).json(data);
                        return [3 /*break*/, 3];
    ...
    UserController.prototype.indexAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, service_1.default.signIn(req.body)];
                    case 1:
                        token = _a.sent();
                    ...
                    case 2:
                        error_5 = _a.sent();
                        res.status(error_5.status || 500).json({ error: error_5 });
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_6 = _a.sent();
                        res.status(error_6.status || 500).json(error_6);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
