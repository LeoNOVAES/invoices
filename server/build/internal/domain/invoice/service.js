...
var invoiceRepository_1 = __importDefault(require("../../infra/repository/invoiceRepository"));
var InvoiceService = /** @class */ (function () {
    function InvoiceService() {
    }
    InvoiceService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, invoiceRepository_1.default.save(data)];
    ...
    InvoiceService.prototype.index = function (id, number) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
